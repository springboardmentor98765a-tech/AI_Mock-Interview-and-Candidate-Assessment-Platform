...
public class PlatformController {
    ...
    /**
     * Public, unauthenticated version of ONLY the aggregate stat cards used to
     * render the marketing/landing page hero stats (total users, recruiters,
     * AI usage). The landing page previously called the ADMIN-only
    ...
    public ResponseEntity<PlatformDashboardResponse> getPublicPlatformStats() {
        ...
        publicStats.setStats(full.getStats());
