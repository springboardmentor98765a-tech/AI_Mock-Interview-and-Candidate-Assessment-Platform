...
def _build_or_regenerate_assessment(interview_id: str, current_user: Optional[Dict[str, Any]] = None) -> AssessmentReport:
    ...
    # Trigger real in-app notification & email for candidate
    try:
        ...
        cand_user = db.users.get(candidate_id, {})
        cand_email = cand_user.get("email", "candidate@example.com")
        
        create_in_app_notification(
            user_id=candidate_id,
            title="Assessment Evaluation Completed",
            message=f"AI Scoring for {domain} ({interview_id}) ready. Overall: {overall_score}/100 ({recommendation}).",
        ...
        send_email_notification(
            ...
            details={
                ...
                "overall_score": overall_score,
                "recommendation": recommendation,
                "technical_score": tech_breakdown.score,
                "communication_score": comm_breakdown.score,
                "confidence_score": conf_breakdown.score,
                "professionalism_score": prof_breakdown.score
            }
        ...
        print(f"[Assessment Notification Warning] {e}")
