...
def start_session(
    ...
    create_in_app_notification(
        ...
        message=f"Your {interview.get('domain', 'Technical')} interview session is now active.",
        notification_type="session_start",
        related_id=interview_id,
        action_url=f"#session"
    )
...
def finalize_interview(
    ...
    # Trigger session completed notification & email
    create_in_app_notification(
        user_id=current_user["id"],
        title="Mock Interview Completed",
        message=f"Session completed with {interview.get('questions_attempted', len(interview['questions']))} questions. AI Score: {report.get('overall_score', 'N/A')}/100.",
    ...
    send_email_notification(
        ...
        details={
            ...
            "questions_attempted": interview.get("questions_attempted", len(interview["questions"])),
