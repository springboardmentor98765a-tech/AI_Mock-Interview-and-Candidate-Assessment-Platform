...
def apply_vision_to_scores(conn, interview_id: int):
    """
    Fold measured Module 6 metrics into the Confidence & Professionalism
    pillars, recompute overall + rating, persist analysis breakdowns.
    Returns the applied summary dict for logging/testing.
    """
    row = conn.execute(
