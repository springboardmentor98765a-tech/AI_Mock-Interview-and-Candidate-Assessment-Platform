...
function candidateOverview() {
  ...
  var rubricTiers = [
    ...
    { range: '75–89%', label: 'Good', text: 'text-indigo-300', bg: 'bg-indigo-500/10', border: 'border-indigo-500/20', activeBg: 'background:rgba(78, 80, 201, 0.22);border:1.5px solid #818cf8' },
      ...
      return `<div class="flex items-start gap-2.5">
        ...
        ${report.vision_metrics ? (function () {
          ...
          return `<div class="report-section" id="report-vision">
            <div class="flex items-center gap-2 mb-3">
              <span class="w-7 h-7 rounded-lg flex items-center justify-center" style="background:rgba(6,182,212,0.15);color:#67e8f9">${icon('eye', 15)}</span>
