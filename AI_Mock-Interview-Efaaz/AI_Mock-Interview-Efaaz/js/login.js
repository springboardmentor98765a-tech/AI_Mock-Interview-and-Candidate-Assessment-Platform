var GOOGLE_CLIENT_ID = '513359095944-vg5v7ajdag8l6859eja147ipjgffstnm.apps.googleusercontent.com'
    ...
    <div class="login-left hidden lg:flex flex-col justify-between p-12 relative overflow-hidden">
      ...
      <div class="relative">
        <div class="flex items-center gap-2 mb-2">
          <div class="logo-icon">${icon('sparkles', 20)}</div>
          <span class="logo-text">SmartHire AI</span>
        </div>
      </div>
      <div class="relative space-y-8">
        <div>
          <h1 class="login-title"><span style="color:${CYAN}">Smart<br>Interview<br>With AI</h1></span>
          <p class="login-subtitle">Practice smarter with AI-driven interviews, instant performance insights, and personalized guidance built for your career.</p>
        </div>
        <div class="grid grid-cols-3 gap-4">
          ${[{ v: '95%', l: 'Placement Rate' }, { v: '10K+', l: 'Candidates' }, { v: '4.9★', l: 'Avg Rating' }].map(function(s) {
        ...
        <div class="login-feature">
          ...
          <div>
            <p class="text-white/80 text-sm font-medium">SMART-AI Speech Analysis</p>
            <p class="text-white/40 text-xs mt-0.5">Get intelligent feedback on your communication style, speaking confidence, clarity, and interview performance.</p>
          </div>
        </div>
      </div>
      <p class="relative text-white/20 text-xs">&copy; 2026 SmartHire AI. All rights reserved.</p>
    </div>
    <div class="flex-1 flex items-center justify-center p-8" style="background:#09092a">
      <div class="w-full max-w-md">
        ...
        <div class="auth-toggle flex rounded-lg p-1 mb-6" style="background:#141627">
          <button class="auth-toggle-btn flex-1 py-2 rounded-md text-sm font-medium transition-all ${state.authMode === 'login' ? 'active' : ''}" data-mode="login" style="${state.authMode === 'login' ? 'background:' + INDIGO + ';color:#fff' : 'color:rgba(169, 109, 109, 0.56)'}">Sign In</button>
