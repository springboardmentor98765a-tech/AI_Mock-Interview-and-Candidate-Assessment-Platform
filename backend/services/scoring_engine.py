...
def evaluate_answer_full(
    ...
    """Evaluate candidate answer across spoken communication, grammar, fillers, pronunciation, technical accuracy, and professionalism."""
...
def generate_final_report(interview_id: int, conn: Any) -> Dict[str, Any]:
    """Aggregate question evaluations, calculate final weighted scores, rating rubric, and generate feedback analytics."""
