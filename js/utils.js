...
function downloadReportAsPDF(report) {
  ...
  var ratingColor = rating === 'Excellent' ? '#84cc16' : rating === 'Good' ? '#ff7a59' : rating === 'Average' ? '#f5b942' : rating === 'Needs Improvement' ? '#ff5d73' : '#e11d48';
  ...
  <div class="score-banner">
    ...
    <div class="category-grid">
      <div class="cat-card">
        ...
        <div class="progress-bar-bg"><div class="progress-bar-fill" style="width:${comm}%;background:#ff7a59;"></div></div>
      </div>
      <div class="cat-card">
        <div class="cat-header"><span>Confidence (25%)</span><span class="cat-score">${conf.toFixed(0)}%</span></div>
        <div class="progress-bar-bg"><div class="progress-bar-fill" style="width:${conf}%;background:#2dd4bf;"></div></div>
      </div>
      <div class="cat-card">
        <div class="cat-header"><span>Technical Relevance (30%)</span><span class="cat-score">${tech.toFixed(0)}%</span></div>
        <div class="progress-bar-bg"><div class="progress-bar-fill" style="width:${tech}%;background:#84cc16;"></div></div>
      </div>
      <div class="cat-card">
        <div class="cat-header"><span>Professionalism (15%)</span><span class="cat-score">${prof.toFixed(0)}%</span></div>
        <div class="progress-bar-bg"><div class="progress-bar-fill" style="width:${prof}%;background:#f5b942;"></div></div>
      </div>
    </div>
  </div>
      ...
      return `
        <div class="question-card">
          <div class="q-header">
            ...
            <span style="color:#e85d3f;">Score: ${qScore.toFixed(0)}% (${qRating})</span>
          </div>
