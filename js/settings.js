/* ═══════════════════════════════════════════════════════════════════════════
   SMARTHIRE AI — SETTINGS MODULE (CANDIDATE, RECRUITER, ADMIN)
   ═══════════════════════════════════════════════════════════════════════════ */
...
// ── Settings Local Storage & Defaults ──
...
// ── State for active tabs in settings ──
          ...
          <div class="sh-settings-card">
            <div class="sh-card-header">
              <div class="flex items-center gap-2.5">
                ...
                <div>
                  <h3 class="sh-card-title">Vision & Behavioral Telemetry (Module 6)</h3>
          ...
          <div class="sh-settings-card">
            <div class="sh-card-header">
              <div class="flex items-center gap-2.5">
                ...
                <div>
                  <h3 class="sh-card-title">Speech & Fluency Telemetry (Module 5)</h3>
              ...
              <div class="p-4 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 space-y-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-white/70 pt-1">
                  <div class="p-2.5 rounded-xl bg-black/30 border border-white/5">
                    <span class="font-bold text-white block">Module 5 (Speech & Audio)</span>
                    <span class="text-white/40">Web Speech API + WPM & Filler Detector (Client-Side)</span>
                  </div>
                  <div class="p-2.5 rounded-xl bg-black/30 border border-white/5">
                    <span class="font-bold text-white block">Module 6 (Vision & Face Mesh)</span>
...
function bindSettingsEvents() {
  ...
  // ── Recruiter Hiring Standards Save ──
